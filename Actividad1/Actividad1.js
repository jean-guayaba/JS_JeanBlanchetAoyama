...
const CHARMELION = new Pokemon('Charmelion', 'Audaz',  'Fuego', 50,50, 40, 50,50);
const HAUNTER = new Pokemon ('Haunter', 'Osada','Veneno', 50,60,40,30,70);
const HITMONCHAN = new Pokemon ('Hitmonchan', 'Alegre', 'lucha', 65, 70, 75, 70,90);
const JOLTEON = new Pokemon ('Jolteon', 'Audaz', 'Electrico', 80,70,75,80,85);
const UMBREON = new Pokemon('Umbreon','Alegre','Siniestro',100,100,100,100,100);